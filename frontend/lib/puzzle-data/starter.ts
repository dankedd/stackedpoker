  ...
  // ── 2 ────────────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        prompt: 'BB called the flop and checked the turn. The Qs may have improved villain\'s range.',
        options: [
      ...
      },
      {
        ...
        options: [
          { id: 'bet_75',  label: 'Bet $38 (75%)', quality: 'perfect',    evLoss: 0,   coaching: 'Large sizing is correct on the river. BB has shown a lot of calling tendency — they likely have QQ, Kx, or Qx hands. Go for max value with a pot-sized-ish bet.' },
    ...
    summary: 'With sets on dry boards, prefer small cbets to keep villain\'s range wide. As draws don\'t exist, you can afford to go slower on the flop and build naturally. On later streets as the board develops and villain\'s range strengthens, increase sizing to extract maximum value.',
    ...
    steps: [
      {
        ...
        prompt: 'You have AhJh — nut flush draw. BB checks to you.',
        options: [
      ...
      },
      {
        ...
        options: [
          { id: 'call',    label: 'Call $16',     quality: 'perfect',    evLoss: 0,  coaching: 'Calling is correct. The Kd improved some of BB\'s range (Kx hands). You still have ~30% equity with the NFD. Calling with nut flush draw getting good pot odds is standard.' },
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'bluff_50', label: 'Bet $35 (61%)', quality: 'mistake',    evLoss: 3.5, coaching: 'Bluffing into a player who donk-led the turn is low EV. BB checked after showing strength, but they likely have a showdown-worthy hand. Your Ah blocks the flush you missed, not a great bluff here.' },
    ...
    steps: [
      {
        ...
        options: [
          ...
          { id: 'bet_33',  label: 'Bet $11 (33%)', quality: 'mistake',    evLoss: 3.5, coaching: 'Betting here is a bluff — BTN called a 3-bet and hits an ace often enough. You rarely get called by worse, and you commit more money in a bad spot. Check and reassess.' },
  ...
  // ── 7 ────────────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        options: [
          { id: 'bet_33',  label: 'Bet $16 (33%)', quality: 'perfect',    evLoss: 0,  coaching: 'Bet small with your overpair. You need to protect TT from overcards and charge draws. Small sizing keeps UTG\'s wide range in (pocket pairs, 98, AQ all peel small bets).' },
      ...
      },
      {
        ...
        prompt: 'The As arrives. You bet $16. UTG check-raises to $60. Your action with TT?',
        options: [
  ...
  // ── 8 ────────────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        options: [
          { id: 'raise',   label: 'Raise to $180',  quality: 'perfect',    evLoss: 0,  coaching: 'Raise for value and protection. The 9d brings diamond draws — you need to charge them. Your two pair is not the nuts; KdQd, T8 (OESD) are all out there. Get money in now.' },
      ...
      },
      {
        ...
        prompt: 'River 2h — diamond draw bricked. BTN jams $250 into $463. Getting ~2.85:1 pot odds. Hero call or fold?',
        options: [
          { id: 'call',    label: 'Call $250',  quality: 'perfect',    evLoss: 0,  coaching: 'Call. You need to be correct ~26% of the time. BTN can have T8, KdQd, 87, or pure air bluffs. Their range is polarised — top two pair is a clear call at these pot odds.' },
          { id: 'fold',    label: 'Fold',       quality: 'mistake',    evLoss: 8,  coaching: 'Folding top two pair at 2.85:1 pot odds is too tight. BTN jammed into you after calling a 3-bet — their range has many bluffs and you only need to be right 26% of the time.' },
        ],
      },
    ],
    ...
    steps: [
      {
        ...
        options: [
          { id: 'bet_50',  label: 'Bet $5 (62%)',   quality: 'perfect',    evLoss: 0,   coaching: 'Cbet with your OESD. You have ~30% equity. In HU play, cbetting vs BB is highly profitable with any equity + fold equity combination. This is a clear cbet.' },
