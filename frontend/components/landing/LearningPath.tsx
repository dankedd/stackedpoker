      ...
      <div className="container mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-10">
          {STAGES_SHOWN.map((stage) => {
            ...
            return (
              <div key={stage.id} className="rounded-xl border border-border/40 bg-black/20 p-3.5">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {FEATURED_MODULE_IDS.map((id) => {
            const m = MODULES_BY_ID.get(id);
            if (!m) return null;
            return (
              <MarketingGlassCard key={id} className="p-4">
