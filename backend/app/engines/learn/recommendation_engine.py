...
CONCEPT_TO_LESSON: dict[str, str] = {
    ...
    "first_in":               "first-in",
    "rfi":                    "first-in",
    "position_rfi":           "first-in",
    "players_behind":         "first-in",
    "preflop_sizing":          "first-in",
    "antes":                   "first-in",
    "preflop_planning":        "first-in",
    ...
    "range_construction":      "utg-mastery",
    "utg_rfi":                 "utg-mastery",
    "utg1_rfi":                "utg1-mastery",
    "utg2_rfi":                "utg2-mastery",
    "lj_rfi":                  "lj-mastery",
    "hj_rfi":                  "hj-mastery",
    "co_rfi":                  "cutoff-ranges",
    "btn_rfi":                 "button-ranges",
    "limping":                 "the-small-blind-is-different",
    "sb_first_in":             "the-small-blind-is-different",
    "rake_adjustment":         "preflop-foundation-lab",
