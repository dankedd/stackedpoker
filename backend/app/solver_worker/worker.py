    ...
    async def _execute_job(self, job: SolveJob) -> None:
        ...
        try:
            ...
            solver_config = SolverConfig(
                ...
                turn_bet_sizes=config.turn_bet_sizes,
                turn_raise_sizes=config.turn_raise_sizes,
                river_bet_sizes=config.river_bet_sizes,
                river_raise_sizes=config.river_raise_sizes,
                rake=config.rake,
